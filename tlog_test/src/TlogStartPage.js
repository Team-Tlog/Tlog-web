    ...
    <div className="flex justify-center items-center min-h-screen bg-white">
      <div className="w-full max-w-xs flex flex-col justify-start items-center pt-36 px-5 h-[667px] bg-white">
        <div className="text-center flex flex-col justify-start items-center w-full max-w-xs mx-auto">
          ...
          <p className="text-sm text-gray-500 leading-relaxed mb-2">테스트 하고 성격에 맞는 여행 즐기러 가볼까요?</p>
          <br></br>
          <p className="text-sm text-gray-500 leading-relaxed mb-2">여행 성향을 분석해 나만의 여행 유형을</p>
          <p className="text-sm text-gray-500 leading-relaxed mb-2">찾아주는 맞춤형 여행 성향 테스트입니다</p>
          <button 
